(function() {
                ...
                <div class="game-container">
                    <div class="game-header">
                        <div class="header-left">
                            ...
                            <button id="btn-new-game" class="new-game-btn">新游戏</button>
                        </div>
    ...
    // --- 游戏核心控制 ---
    function startGame() {
        document.getElementById('game-overlay').style.display = 'none';// 隐藏遮罩层
        document.activeElement.blur(); // 移除焦点，防止点击按钮后，按方向键再次触发按钮点击
